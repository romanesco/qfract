...
const char* NAME = "Skew product map by Inou-Nakane (base space)";
const char* CHILD = "inou-nakane-skew2.so";
...
const int N=5;
double VALUE[N]={1.0, 0.0, 0.0, 0.0, 0};
const Parameter PARAM( N, VALUE );
const char * PARAMDESC[N] = { "Re(a)", "Im(a)", "Re(b)", "Im(b)", "CritOrbit?" };
