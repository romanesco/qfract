...
const char* NAME = "Tricorn with parabolic 3-periodic point (close to Julia-Lavaurs set, parameter space)";
const char* CHILD = "tricorn-closetoLavaursper3-rayjulia.so";
...
const char* PARAMDESC[N] = { "phase offset" };
...
int iter(Point z, Parameter param, int max)
{
  ...
  double phase = z.x - param.Value(0)*z.y*z.y;
