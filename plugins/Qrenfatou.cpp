/*
 * Fatou coordinate of renormalization for
 * exp(2*pi*i*alpha)Q(z-b) 
 * (where Q(z) = z(1+1/z)^6/(1-1/z)^4)
...
const char* NAME = "e^{2\\pi i alpha}Q(z-b) (in pre-Fatou coordinate)";
const char* CHILD = "";
